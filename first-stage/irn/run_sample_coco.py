...
if __name__ == '__main__':
    ...
    parser.add_argument("--recam_loss_weight", default=0.1, type=float)
    parser.add_argument("--recam_batch_size", default=6, type=int)
    ...
    # Output Path
    parser.add_argument("--work_space", default="result_coco", type=str) # set your path
    ...
    parser.add_argument("--score_dir", default="score", type=str)
    parser.add_argument("--check_dir", default="check", type=str)
